...
class SignSheet extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['name', 'gender', 'old', 'minzu','idcard', 'birth', 'graduate', 'cat1','cat2','height', 'weight', 'yw', 'sx', 'yy', 'wl', 'hx', 'sw', 'zz', 'dl', 'ls', 'sy', 'ty', 
            'photo', 'graduate_id', 'score', 'parentname', 'parentrelation', 'parentphone','payacount',
             'paytime'], 'required'],
            ...
            [['yw', 'sx', 'yy'],'number','max'=>120,'min'=>0],
            [['wl', 'hx', 'sw', 'zz', 'dl', 'ls'],'number','max'=>100,'min'=>0],
            ['sy','number','max'=>30,'min'=>0],
            ['ty','number','max'=>80,'min'=>0],
            ...
            [['birth'], 'string', 'max' => 30],
             [['graduate', 'cat3', 'parentname', 'payacount', 'note', 'verifymsg'], 'string', 'max' => 100],
